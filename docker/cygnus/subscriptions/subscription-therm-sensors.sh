...
# ul20 client temperature sensors
cat <<EOF | curl ${ORION_URL} -s -S --header 'Content-Type: application/json' --header 'Accept: application/json' --header 'Fiware-Service: devguideiot' --header 'Fiware-ServicePath: /' -d @-
{
    "entities": [
        {
            "type": "thing",
