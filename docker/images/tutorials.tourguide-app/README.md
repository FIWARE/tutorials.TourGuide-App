...
The file `docker-compose.yml` can be downloaded from [here](https://raw.githubusercontent.com/Fiware/tutorials.TourGuide-App/release/0.5/docker/compose/docker-compose.yml).
...
Also, there are several environment variables that you can configure in the [docker-compose.yml](https://raw.githubusercontent.com/Fiware/tutorials.TourGuide-App/release/0.5/docker/compose/docker-compose.yml):
...
End to end testing can be done using the [REST interface](http://docs.tourguide.apiary.io). An example application is [the restaurant data feeder](https://github.com/Fiware/tutorials.TourGuide-App/blob/release/0.5/server/feeders/restaurantfeeder.js).
...
This IdM image is intended to work with [Fiware TourGuide-App](https://github.com/Fiware/tutorials.TourGuide-App). Due to this, we've generated Users, Organizations, Apps, Roles and Permissions adapted to it in this uncoupled  [file](https://github.com/Fiware/tutorials.TourGuide-App/blob/release/0.5/docker/images/tutorials.tourguide-app/keystone_provision.py).
...
We've added several permissions for Orion Operations. You can check all of them by accessing the IdM or [here](https://github.com/Fiware/tutorials.TourGuide-App/blob/release/0.5/docker/images/tutorials.tourguide-app/keystone_provision.py#L186)

## User feedback

### Documentation

All the information regarding the image generation is hosted publicly on [Github](https://github.com/Fiware/tutorials.TourGuide-App/tree/release/0.5/docker/images/tutorials.TourGuide-App).
